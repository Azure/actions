...
- Contributing to Azure Actions
  - [Building GitHub Actions from Azure Pipeline Tasks](docs/Process_of_Authoring_GitHub_Actions_for_Azure.md#creating-a-new-github-action-for-azure-or-microsoft)
